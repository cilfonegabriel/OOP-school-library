...
```cd my-folder   
    git clone git@github.com:cilfonegabriel/OOP-school-library.git
...
Feel free to check the [issues page](https://github.com/cilfonegabriel/OOP-school-library/issues).
<p align="right">(<a href="#readme-top">back to top</a>)</p>
